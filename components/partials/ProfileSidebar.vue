<template>
  <div class="dashboard-sidebar">
          <nuxtLink :class="currentPage === 'orders' && 'dashboard-link w--current' || 'dashboard-link'" to="/dashboard/orders">
            <div class="dashboard-link_icon w-embed">
