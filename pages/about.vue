    ...
    <section class="c-section cc-small-width">
      <div class="founders-section">
        ...
        <div class="founders-image">
          <img alt="" class="c-img cc-cover" loading="lazy" sizes="(max-width: 767px) 90vw, (max-width: 991px) 44vw, 41vw" 
      ...
      <div class="about-flex">
        <div class="about-img">
          <img alt="" class="c-img cc-cover" loading="lazy" sizes="(max-width: 767px) 90vw, (max-width: 991px) 41vw, 39vw" 
            :src="about_image.url"
          >
        </div>
...
const fetchPageData = async () => {
    try {
      const response = await fetch('https://cms.quicklaw.ng/api/about?populate=deep'); 
        ...
        founders_image.value = founders_note.value.image.formats.large
        who_we_are.value = content.value.who_we_are_section   
        about_image.value = who_we_are.value.image.formats.medium       
