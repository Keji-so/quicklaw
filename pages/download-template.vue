    ...
    <section class="c-section cc-small-width">
      <div class="download-agreement_section">
        <div class="download-form_container">
          ...
          <h2 class="download-form_header">SELECT A TEMPLATE</h2>
          <div class="form-block w-form">
            <form
              id="wf-form-Download-Form"
              data-name="Download Form"
              data-wf-element-id="ae1177f9-ef0a-374f-766b-63f55115de85"
              data-wf-page-id="66478d188a7cf431ed0b2b29"
              method="get"
              name="wf-form-Download-Form"
            >
              <div class="c-form_field cc-sm">
                <div class="c-label_wrapper">
                  <div class="c-label">Select A Template</div>
                </div>
              ...
              <div class="c-form_field cc-sm">
                <div class="c-label_wrapper">
                  <div class="c-label">Full Name</div>
                </div>
              ...
              <div class="c-form_field cc-sm">
                <div class="c-label_wrapper">
                  <div class="c-label">Email Address</div>
                </div>
                <div class="c-input_wrapper">
                  <input
                    id="email"
              ...
              <div class="c-form_field cc-sm">
                <div class="c-label_wrapper">
                  <div class="c-label">Phone Number</div>
                </div>
                <div class="c-input_wrapper">
                  <input
                    id="phone-number"
                ...
                <div
                  v-if="v$.formData.phone_number.$errors.length"
              ...
              <div class="order-details">
                <div class="order-details_inner">
                  ...
                  <div class="order-price">
                    <div>
                      ₦{{ numberEmptyState(formatNumber(selectedService?.price, "0,0")) }}
                    </div>
                  </div>
                </div>
                <div class="order-code_image">
                  <img
                    ...
                    class="c-img"
                    loading="lazy"
                    src="@/public/assets/images/la_qrcode.png"
                  />
                </div>
              </div>
            </div>
...
const fetchPageData = async () => {
  try {
    const response = await fetch(
      "https://cms.quicklaw.ng/api/download-template?populate=deep"
    );
    if (!response.ok) {
...
const fetchAllServices = async () => {
  ...
  try {
    ...
    if (data.value) {
      ...
      const filteredServices = data.value.data.filter(service => service.is_quote_service === false);       
...
const prefillForm = () => {
  ...
  if (auth.value.user) formData.value.profile_payload = deepClone(auth.value.user);
};
