      ...
      <div class="c-dashboard">
        ...
        <div class="dashboard-container">
          ...
          <div class="form-block w-form">
            <form id="profile-form" class="profile-form" name="profile-form" @submit.prevent="submitForm">
              <div class="profile-form_inner">
                ...
                <div class="form-flex cc-profile">
                  <div class="c-form_field">
                    ...
                    <div class="c-input_wrapper">
                      <input id="first-name" v-model="formData.first_name" class="c-input w-input"
                        :class="{ 'cc-error': v$.first_name.$error }" maxlength="256" name="first-name"
                        placeholder="Enter your First Name &amp; Last Name" type="text">
                    </div>
                    <div v-if="v$.first_name.$errors.length" class="c-help cc-error">
                  ...
                  <div class="c-form_field">
                    ...
                    <div class="c-input_wrapper">
                      <input id="last-name" v-model="formData.last_name" class="c-input w-input"
                        :class="{ 'cc-error': v$.last_name.$error }" maxlength="256" name="last-name"
                        placeholder="Enter your Last Name" type="text">
                    </div>
                    <div v-if="v$.last_name.$errors.length" class="c-help cc-error">
                ...
                <div class="form-flex  cc-profile">
                  <div class="c-form_field cc-mb-0">
                    ...
                    <div class="c-input_wrapper">
                      <input v-model="formData.username" class="c-input w-input"
                        :class="{ 'cc-error': v$.formData.username.$error }" maxlength="256" name="username"
                        placeholder="chizichat_a" type="text">
                    </div>
                    ...
                    <div class="c-input_wrapper">
                      <input id="email" v-model="formData.email" class="c-input w-input"
              ...
              <div class="profile-form_inner">
                ...
                <div class="form-flex cc-profile">
                  <div class="c-form_field cc-mb-0">
                    ...
                    <div class="c-input_wrapper">
                      <input id="current-password" class="c-input w-input"
                        :class="{ 'cc-error': v$.password.$error }" v-model="formData.password" maxlength="256"
                  ...
                  <div class="c-form_field cc-mb-0">
                    ...
                    <div class="c-input_wrapper">
                      <input id="new-password" class="c-input w-input"
                        :class="{ 'cc-error': v$.new_password.$error }" v-model="formData.new_password"
                        maxlength="256" name="new-password" placeholder="Choose a Password"
                        :type="isNewPasswordVisible ? 'text' : 'password'">
                      <div @click="toggleNewPasswordVisibility" class="reveal-toggle"
                        :class="isNewPasswordVisible && 'cc-hidden'" />
                    </div>
                    <div v-if="v$.new_password.$errors.length" class="c-help cc-error">
...
const rules = computed(() => ({
  formData: {
    ...
    password: { required: helpers.withMessage('Required', required), minLengthValue: minLength(8) },
    new_password: { required: helpers.withMessage('Required', required), minLengthValue: minLength(8) },
    username: {
...
const submitForm = async () => {
  ...
  //   }
  //   else {
  //  // const { data } = await usePost(changePasswordState.value.url, formData)
